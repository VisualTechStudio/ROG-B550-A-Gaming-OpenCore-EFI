# ROG-B550-A-Gaming-OpenCore-EFI

README-zh_CN.md

使用本仓库EFI的设备完美运行在MacOS Tahoe(26):
...
# 工作情况
正常工作:
Apple服务(iCloud/iMessage/FaceTime)
GPU硬件加速(Metal 2)
CPU电源管理(AMDRyzenCPUPowerManagement)
USB端口
Wifi和蓝牙
睡眠/关闭显示器
板载声卡
...
4.进入系统后使用https://github.com/laobamac/OCLP-Mod/releases的最新版本下载并安装 OS KDK 和 Root Patch
